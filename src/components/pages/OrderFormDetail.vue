<template>
<div>
  <el-button type="primary" @click="showStyleDialog">添 加</el-button>

  <el-dialog :visible="styleDialogVisible" title="款 式" @close="closeStyleDialog"
  ...
  <el-dialog :visible="lotDialogVisible" title="批 次" @close="closeLotDialog"
